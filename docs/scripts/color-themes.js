 ...
 * @type {Color}
 */
// TODO import from /models/classes/Color.class.js
var Color = (function () {
  // CONSTRUCTOR
  /**
  ...
  function Color($rgb) {
    ...
    self._HSV_HUE = (function () {
      ...
      return [
        function (r, g, b) { return (((g - b) / _chroma % 6)+6)%6 * 60 } // FIXME bug with modular (-7 % 6) === -1
...
var colorStyles = function colorStyles($primary, $secondary) {
...
$('#docs input.js-picker').change(function () {
  var primary = Color.fromHex($('#docs input.js-picker-primary').val())
  var secondary = Color.fromHex($('#docs input.js-picker-secondary').val())
