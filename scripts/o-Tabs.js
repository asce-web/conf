...
function updateTabs() {
  ...
  $(this).parents('.o-Tabs__Tab').each(function () {
    ...
    $(this).prevAll('.o-Tabs__Tab').next('.o-Tabs__Panel--js').addClass('o-Tabs__Panel--hiddenBefore').attr('aria-hidden', true)
    $(this).nextAll('.o-Tabs__Tab').next('.o-Tabs__Panel--js').addClass('o-Tabs__Panel--hiddenAfter' ).attr('aria-hidden', true)
  })
  resizeTabBlock()
}
