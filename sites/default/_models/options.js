...
module.exports = Object.assign(require('../../all/_models/options.js'), {
  site: (function () {
    ...
    site.currentConference()
      .addProgramEvent(new Session({ start_date: '2016-09-28 10:00', end_date: '2016-09-28 19:00', name: 'Registration'                            }))
      .addProgramEvent(new Session({ start_date: '2016-09-28 10:30', end_date: '2016-09-28 16:30', name: 'Technical Tours'                         }).url('#0').star())
      .addProgramEvent(new Session({ start_date: '2016-09-28 13:00', end_date: '2016-09-28 17:00', name: 'Short Courses'                           }).url('#0').star())
      .addProgramEvent(new Session({ start_date: '2016-09-28 12:00', end_date: '2016-09-28 17:00', name: 'Optional Tours'                          }).url('#0').star())
      .addProgramEvent(new Session({ start_date: '2016-09-28 17:30', end_date: '2016-09-28 19:30', name: 'Opening Welcome Reception'               }))
      .addProgramEvent(new Session({ start_date: '2016-09-28 13:00', end_date: '2016-09-28 17:00', name: 'Community Service Project'               }))

      .addProgramEvent(new Session({ start_date: '2016-09-29 07:00', end_date: '2016-09-29 16:30', name: 'Registration'                            }))
      .addProgramEvent(new Session({ start_date: '2016-09-29 07:30', end_date: '2016-09-29 08:30', name: 'Student & Emerging Leaders Welcome'      }))
      .addProgramEvent(new Session({ start_date: '2016-09-29 08:30', end_date: '2016-09-29 10:00', name: 'Opening Plenary Session'                 }).star())
      .addProgramEvent(new Session({ start_date: '2016-09-29 09:30', end_date: '2016-09-29 15:30', name: 'Guest Program Orientation & Tour'        }).star())
      .addProgramEvent(new Session({ start_date: '2016-09-29 10:00', end_date: '2016-09-29 10:30', name: 'Beverage Break'                          }))
      .addProgramEvent(new Session({ start_date: '2016-09-29 10:30', end_date: '2016-09-29 11:30', name: 'Concurrent Sessions'                     }))
      .addProgramEvent(new Session({ start_date: '2016-09-29 11:45', end_date: '2016-09-29 13:45', name: 'Celebration of Leaders Luncheon'         }).star())
      .addProgramEvent(new Session({ start_date: '2016-09-29 14:00', end_date: '2016-09-29 15:30', name: 'Concurrent Sessions'                     }))
      .addProgramEvent(new Session({ start_date: '2016-09-29 14:00', end_date: '2016-09-29 18:00', name: 'Communities and Pavilion'                }))
      .addProgramEvent(new Session({ start_date: '2016-09-29 15:30', end_date: '2016-09-29 16:00', name: 'Beverage Break'                          }))
      .addProgramEvent(new Session({ start_date: '2016-09-29 16:00', end_date: '2016-09-29 17:30', name: 'Concurrent Sessions'                     }))
      .addProgramEvent(new Session({ start_date: '2016-09-29 18:45', end_date: '2016-09-29 21:45', name: 'Optional Tour'                           }).url('#0').star())

      .addProgramEvent(new Session({ start_date: '2016-09-30 07:00', end_date: '2016-09-30 16:30', name: 'Registration'                            }))
      .addProgramEvent(new Session({ start_date: '2016-09-30 07:30', end_date: '2016-09-30 08:30', name: 'Leadership & Society Awards Breakfast'   }))
      .addProgramEvent(new Session({ start_date: '2016-09-30 08:30', end_date: '2016-09-30 17:00', name: 'Communities and Pavilion'                }))
      .addProgramEvent(new Session({ start_date: '2016-09-30 08:45', end_date: '2016-09-30 09:45', name: 'ASCE Annual Business Meeting'            }).star())
      .addProgramEvent(new Session({ start_date: '2016-09-30 09:45', end_date: '2016-09-30 10:15', name: 'Beverage Break'                          }))
      .addProgramEvent(new Session({ start_date: '2016-09-30 10:15', end_date: '2016-09-30 11:45', name: 'Concurrent Sessions'                     }))
      .addProgramEvent(new Session({ start_date: '2016-09-30 11:45', end_date: '2016-09-30 13:15', name: 'Lunch on Your Own'                       }))
      .addProgramEvent(new Session({ start_date: '2016-09-30 11:45', end_date: '2016-09-30 13:15', name: 'International Luncheon (ticketed)'       }))
      .addProgramEvent(new Session({ start_date: '2016-09-30 13:15', end_date: '2016-09-30 14:15', name: 'Concurrent Sessions'                     }))
      .addProgramEvent(new Session({ start_date: '2016-09-30 13:00', end_date: '2016-09-30 17:15', name: 'Optional Tour'                           }).url('#0').star())
      .addProgramEvent(new Session({ start_date: '2016-09-30 14:30', end_date: '2016-09-30 16:00', name: 'Industry Leaders Forum'                  }).star())
      .addProgramEvent(new Session({ start_date: '2016-09-30 16:00', end_date: '2016-09-30 16:30', name: 'Beverage Break'                          }))
      .addProgramEvent(new Session({ start_date: '2016-09-30 16:30', end_date: '2016-09-30 17:30', name: 'Concurrent Sessions'                     }))
      .addProgramEvent(new Session({ start_date: '2016-09-30 18:30', end_date: '2016-09-30 21:30', name: 'Theater Night Out'                       }).star())

      .addProgramEvent(new Session({ start_date: '2016-10-01 07:00', end_date: '2016-10-01 14:30', name: 'Registration'                            }))
      .addProgramEvent(new Session({ start_date: '2016-10-01 07:30', end_date: '2016-10-01 08:15', name: 'Order of the Engineer Ceremony'          }).star())
      .addProgramEvent(new Session({ start_date: '2016-10-01 08:45', end_date: '2016-10-01 11:45', name: 'Optional Tour'                           }).url('#0'))
      .addProgramEvent(new Session({ start_date: '2016-10-01 08:30', end_date: '2016-10-01 10:00', name: 'Concurrent Sessions'                     }))
      .addProgramEvent(new Session({ start_date: '2016-10-01 08:30', end_date: '2016-10-01 14:00', name: 'Communities and Pavilion'                }))
      .addProgramEvent(new Session({ start_date: '2016-10-01 10:15', end_date: '2016-10-01 11:45', name: 'Concurrent Sessions'                     }))
      .addProgramEvent(new Session({ start_date: '2016-10-01 12:00', end_date: '2016-10-01 14:00', name: 'ASCE Luncheon & Closing General Session' }).star())
      .addProgramEvent(new Session({ start_date: '2016-10-01 14:30', end_date: '2016-10-01 17:30', name: 'Technical Tours'                         }).url('#0'))
